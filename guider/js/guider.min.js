...
let guider_template = {
	...
	get_login_template: function(){
		let templet = ''
			+ '<form class="badge-dark m-1 p-1">'
			+	'<div class="form-group container-fluid">'
			+		'<div class="p-4"></div>'
			+		'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+			'<div class="col-1">'
			+				'<label class="m-auto" for="username">'
			+					'<i class="icon-user-circle text-white" style="font-size: 25px;"></i>'
			+				'</label>'
			+			'</div>'
			+			'<div class="col-10">'
			+				'<input id="username" type="text" placeholder="请填入用户...">'
			+			'</div>'
			+		'</div>'
			+		'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+			'<div class="offset-1 col-10">'
			+				'<p class="m-0 text-danger font-weight-light">账号错误</p>'
			+			'</div>'
			+		'</div>'
			+		'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+			'<div class="col-1">'
			+				'<label class="m-auto" for="password">'
			+					'<i class="icon-key text-white" style="font-size: 25px;"></i>'
			+				'</label>'
			+			'</div>'
			+			'<div class="col-10">'
			+				'<input id="password" type="password" placeholder="请填入密码...">'								
			+			'</div>'
			+		'</div>'
			+		'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+			'<div class="offset-1 col-10">'
			+				'<p class="m-0 text-danger font-weight-light">密码错误</p>'
			+			'</div>'
			+		'</div>'							
			+		'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+			'<div class="col-3">'
			...
			+			'</div>'
			+			'<div class="col-3">'
			+				'<button id="guider-sign-btn" class="btn btn-sm btn-danger">注册</button>'
			+			'</div>'
			+		'</div>'
			+		'<div class="p-3"></div>'
			+	'</div>'
	...
	get_sign_template: function() {
		let template =	''
			...
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="offset-1 col-10">'
			+					'<p class="m-0 text-danger font-weight-light">用户名已存在</p>'
			+				'</div>'
			+			'</div>'
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="col-1">'
			...
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="offset-1 col-10">'
			+					'<p class="m-0 text-danger font-weight-light">密码过于简单</p>'
			+				'</div>'
			+			'</div>'
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="col-1">'
			+					'<label class="m-auto" for="password2">'
			+						'<i class="icon-key text-white" style="font-size: 25px;"></i>'
			+					'</label>'
			+				'</div>'
			+				'<div class="col-10">'
			...
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="offset-1 col-10">'
			+					'<p class="m-0 text-danger font-weight-light">两次密码输入不一致</p>'
			+				'</div>'
			+			'</div>'
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="col-1">'
			+					'<label class="m-auto" for="email">'
			+						'<i class="icon-envelope text-white" style="font-size: 25px;"></i>'
			+					'</label>'
			+				'</div>'
			+				'<div class="col-10">'
			+					'<input id="email" type="email" placeholder="请填入邮箱...">'
			+				'</div>'
			+			'</div>'
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="offset-1 col-10">'
			+					'<p class="m-0 text-danger font-weight-light">该邮箱已被注册</p>'
			+				'</div>'
			+			'</div>'
			+			'<div class="row mx-3 my-1 align-items-center justify-content-center">'
			+				'<div class="col-3">'
			+					'<button id="login-login" class="btn btn-sm btn-primary">注册并验证</button>'
			+				'</div>'
			+				'<div class="col-1">'
			+				'</div>'
			+				'<div class="col-6">'
			+					'<button id="others-login" class="btn btn-sm btn-danger">社交账号登录</button>'
			+				'</div>'
			+			'</div>'
			+			'<div class="p-3"></div>'
			+		'</div>'
...
// 	})
	...
	$('#search-input-text').keydown(function(e){
		...
		if(keyCode == 40){
				...
				// 改变样式
				let group = $('#guider-input-option-group');
				// 列表
				let li_arrs = group.find('li');
				for (let i=0 ; i < li_arrs.length ; i++){
					// 选中元素,增加选中样式;其他去除样式
	...
	$('#search-input-text').keyup(function(e){
		...
		let input_str = $('#search-input-text').val();
		if(!input_str){
			// 清空返回
			let group = $('#guider-input-option-group');
			group.html('');
...
// 	});
	...
	function addUriTemplet(siteName,siteUri){
		...
		let templet = '<div class="col-lg-2 pt-md-2 guider-uri-btn">'
    ...
    $(document).click(function (e) {
		// 侧边栏按钮区域
		let icon_list_area = $('#sidebar-ico');
		// 侧边栏区域
        let sidebar_others_area = $("#sidebar");
		// 如果点击侧边栏按钮
	...
	// 点击用户名,登录
	$('#guider-user-name').click(function(e){
		let template = guider_template.get_login_template();
		$('#guider-sidebar-content-middle').html(template);
	})
	
	// 点击注册
	$('#guider-sidebar-content-middle').on('click','#guider-sign-btn',function(e){
		e.preventDefault();
		let template = guider_template.get_sign_template();
		$('#guider-sidebar-content-middle').html(template);
		// 阻止form默认跳转
		return false;
	})
